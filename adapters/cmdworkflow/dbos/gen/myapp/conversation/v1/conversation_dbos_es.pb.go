...
// DBOSService exposes the v1.Conversation aggregate as a set of
...
func NewDBOSService(wf *cmdworkflow.Workflow[*v1.Conversation, v1.Command, v1.Event], opts ...DBOSServiceOption) *DBOSService {
...
func (s *DBOSService) Start(ctx dbos1.DBOSContext, cmd *v1.Start) (*v1.Conversation, error) {
...
func (s *DBOSService) AppendUserMessage(ctx dbos1.DBOSContext, cmd *v1.AppendUserMessage) (*v1.Conversation, error) {
	tenant := cmd.GetTenantId()
	sid, err := es.NewStreamID(tenant, "conversation", cmd.GetConversationId())
	if err != nil {
		return nil, err
...
func (s *DBOSService) AppendAssistantMessage(ctx dbos1.DBOSContext, cmd *v1.AppendAssistantMessage) (*v1.Conversation, error) {
	tenant := cmd.GetTenantId()
	sid, err := es.NewStreamID(tenant, "conversation", cmd.GetConversationId())
	if err != nil {
		return nil, err
...
func (s *DBOSService) Close(ctx dbos1.DBOSContext, cmd *v1.Close) (*v1.Conversation, error) {
	tenant := cmd.GetTenantId()
	sid, err := es.NewStreamID(tenant, "conversation", cmd.GetConversationId())
	if err != nil {
		return nil, err
