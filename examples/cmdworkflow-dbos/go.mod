module github.com/laenenai/eventstore/examples/cmdworkflow-dbos
...
require (
	...
	github.com/laenenai/eventstore/adapters/storage/postgres v0.0.0-00010101000000-000000000000 // indirect
